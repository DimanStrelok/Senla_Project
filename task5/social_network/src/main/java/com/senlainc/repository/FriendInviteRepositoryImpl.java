...
@Component(interfaceClass = FriendInviteRepository.class)
public class FriendInviteRepositoryImpl extends AbstractRepository<FriendInvite> implements FriendInviteRepository {
    @Override
